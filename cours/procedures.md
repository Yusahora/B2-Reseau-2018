...
Par exemple depuis mon laptop, je veux accéder à mon ordi fixe qui a l'IP `192.168.1.19` et je veux pouvoir le `ping` en faisant `ping monpc.chez moi`, j'écris dans le fichier /etc/hosts de mon **laptop** :
```
